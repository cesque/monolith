...
export async function saveMetaImage(slug) {
    ...
    console.log(`...writing ${ slug || `index` }.png`)
    await fs.writeFile(`public/thumbnails/${ slug || `index` }.png`, buffer)
    console.log(`wrote ${ slug || `index` }.png to thumbnails!`)
}